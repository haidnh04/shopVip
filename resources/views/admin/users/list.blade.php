...
@section('content')
    <div class="card-header">
        ...
        <button type="submit" type="button" class="btn btn-success" onclick="window.location.href='/admin/users/list'">
    ...
    <div class="modal fade" id="exampleModalLong2" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <form method="get" action="{{ route('listUser') }}" role="search">
                    {{-- @csrf --}}
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Tìm kiếm thành viên</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
